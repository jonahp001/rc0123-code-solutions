...
function renderPokemon(pokemon) {
  ...
  var newColumn3 = document.createElement('div');
  newColumn3.setAttribute('class', 'column-third');

  var pokeDiv = document.createElement('div');
  pokeDiv.setAttribute('class', 'pokemon-card');
  newColumn3.appendChild(pokeDiv);

  var pokeImgCreation = document.createElement('img');
  pokeImgCreation.setAttribute('src', pokemon.imageUrl);
  pokeDiv.appendChild(pokeImgCreation);

  var pokeText = document.createElement('div');
  pokeText.setAttribute('class', 'pokemon-card-text');
  pokeDiv.appendChild(pokeText);

  var pokeH2 = document.createElement('h2');
  pokeH2.textContent = pokemon.name;
  pokeText.appendChild(pokeH2);

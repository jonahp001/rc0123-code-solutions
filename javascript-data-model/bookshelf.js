...
console.log('value of author in 2nd book:', bookshelf[1].author);

console.log('value of ISBN in 1st book:', bookshelf[0].isbn);

console.log('value of title in 3rd book:', bookshelf[2].title);
